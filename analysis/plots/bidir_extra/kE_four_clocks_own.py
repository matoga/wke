...
P = (0, 1, 1.8, 2)  # 1.8: the optimal p of large-N from the E_k mismatch (bidir_p_optimal)
...
axes[2].set(xlabel='t ā^1.8 (ms), ā = a/300 a₀', xlim=(0, TMAX), title='large-N optimum: t ā^1.8 (p = 1.8)')
axes[3].set(xlabel='t ā² (ms), ā = a/300 a₀', xlim=(0, TMAX), title='kinetic clock: t ā² (p = 2)')
...
fig.tight_layout()
save(fig, study, 'bidir_kE_four_clocks', arrays)
