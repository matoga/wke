...
study = 'analysis/results/2026-09-24_bidir-chain-uv-standard'
...
fig.suptitle('Energy peak k_E against t ā^p: large-N (dashed, bubble chain, Bose +1) and measured (solid)', y=1.0)
fig.tight_layout()
